...
function getPreferredQueryName(query) {
  const rememberedPlace = getRememberedPlaceName(query) || query.trim();
...
async function searchFrostSources(query, env) {
  ...
  const preferredQuery = getPreferredQueryName(trimmedQuery);
